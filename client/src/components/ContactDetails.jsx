                ...
                {oldexpenses.map((expense, index) => (
                    <div key={index} className="p-4 border border-gray-300 rounded-lg sm:rounded-3xl shadow-md hover:shadow-lg transition duration-200">
                        ...
                        <div className="flex flex-col sm:flex-row sm:justify-between mt-2">
                            ...
                            <button onClick={() => handleRemoveExpense(expense._id)} className=" text-white px-0 py-1 rounded-full text-sm font-semibold flex items-center justify-center border-red-500">
